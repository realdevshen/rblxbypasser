...
const DISCORD_INVITE_CODE = "https://discord.gg/.gg/s2UQ4BP2SR
";
...
const DiscordInviteCard = () => {
  ...
  return (
    <a
      ...
      className="group relative block overflow-hidden rounded-xl border border-primary/30 hover:border-primary/60 bg-gradient-to-br from-primary/15 via-secondary/60 to-background/80 backdrop-blur-sm p-3 transition-all duration-300 hover:shadow-[0_0_24px_hsl(var(--primary)/0.35)] hover:-translate-y-0.5 animate-fade-in"
    >
      ...
      <div className="relative flex items-center gap-3">
        <div className="relative shrink-0">
          {info.iconUrl ? (
            <img src={info.iconUrl} alt={info.name} className="w-11 h-11 rounded-lg border border-border/50 object-cover" loading="lazy" />
          ) : (
